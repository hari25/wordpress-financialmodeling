...
### == Description ==
```
This plugin uses Financial Modeling Prep API(https://financialmodelingprep.com/) to display the company and stock information. In order to use this plugin, generate an API key by heading to https://financialmodelingprep.com/ and include it in your wp-config.php file eg(define( 'API_KEY', 'Your API Key'))
